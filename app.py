...
def main():
    ...
    if st.button("About"):
        st.text("@Shamik")
        st.text("We developed this application to assist farmers and agricultural enthusiasts in predicting suitable crops based on environmental conditions. 
...
Crops Supported: Rice, Maize, Jute, Cotton, Coconut, Papaya, Orange, Apple, Muskmelon, Watermelon, Grapes, Mango, Banana, Pomegranate, Lentil, Blackgram, Mungbean,Mothbeans,
Pigeonpeas, Kidneybeans, Chickpea, Coffee")
      st.text(" How It Works: 
